...
exports.getIsDisableSecond = exports.getIsDisableMinute = exports.getNumberTime = exports.convertHour = exports.notConvert = void 0;
...
exports.notConvert = notConvert;

var convertHour = (format, ampm, hour) => {
  var index = _props.hoursAmpm.findIndex(hourAmpm => (0, _shared.toNumber)(hourAmpm) === (0, _shared.toNumber)(hour));

  var getHour = notConvert(format, ampm) ? hour : _props.hours24[index];
  return {
    hourStr: getHour,
    hourNum: (0, _shared.toNumber)(getHour)
  };
};
...
var getNumberTime = time => {
  ...
  return {
    hour: (0, _shared.toNumber)(hour),
    minute: (0, _shared.toNumber)(minute),
    second: (0, _shared.toNumber)(second)
  };
};
...
exports.getIsDisableMinute = getIsDisableMinute;
...
exports.getIsDisableSecond = getIsDisableSecond;