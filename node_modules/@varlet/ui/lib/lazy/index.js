...
exports.default = exports._LazyComponent = exports.defaultLazyOptions = exports.imageCache = exports.PIXEL = void 0;
...
var lazyElements = [];
var listenTargets = [];
var imageCache = (0, _shared.createCache)(100);
...
var checkAllWithThrottle = (0, _shared.throttle)(checkAll, defaultLazyOptions.throttleWait);
...
function _check() {
  _check = _asyncToGenerator(function* (el) {
    ;
    (yield (0, _elements.inViewport)(el)) && attemptLoad(el);
  });
  return _check.apply(this, arguments);
}
...
function _add() {
  _add = _asyncToGenerator(function* (el) {
    ...
    (0, _elements.getAllParentScroller)(el).forEach(bindEvents);
    yield check(el);
  });
  return _add.apply(this, arguments);
}
...
function clear(el) {
  (0, _shared.removeItem)(lazyElements, el);
...
var Lazy = {
  ...
  install(app, lazyOptions) {
    ...
    checkAllWithThrottle = (0, _shared.throttle)(checkAll, defaultLazyOptions.throttleWait);
