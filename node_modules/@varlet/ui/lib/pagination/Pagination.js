...
function render(_ctx, _cache) {
  ...
  return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("ul", _hoisted_1, [(0, _vue.withDirectives)((0, _vue.createElementVNode)("li", {
  ...
  /* CLASS */
    ...
    key: 0,
    class: (0, _vue.normalizeClass)(["var-pagination__simple", {
  ...
  /* CLASS */
    ...
    return (0, _vue.withDirectives)(((0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", {
      ...
      class: (0, _vue.normalizeClass)(["var-pagination__item var-elevation--2", {
  ...
  /* KEYED_FRAGMENT */
  )), (0, _vue.withDirectives)((0, _vue.createElementVNode)("li", {
  ...
  /* CLASS */
    ...
    key: 2,
    class: (0, _vue.normalizeClass)(["var-pagination__size", {
      'var-pagination__item-disabled': _ctx.disabled
    }])
    ...
    menu: (0, _vue.withCtx)(() => [((0, _vue.openBlock)(true), (0, _vue.createElementBlock)(_vue.Fragment, null, (0, _vue.renderList)(_ctx.sizeOption, (option, index) => {
      return (0, _vue.withDirectives)(((0, _vue.openBlock)(), (0, _vue.createBlock)(_component_var_cell, {
        class: (0, _vue.normalizeClass)(["var-pagination__list", {
  ...
  /* CLASS */
    ...
    key: 3,
    class: (0, _vue.normalizeClass)(["var-pagination__quickly", {
      'var-pagination__item-disabled': _ctx.disabled
    }])
  ...
  /* CLASS */
  )) : (0, _vue.createCommentVNode)("v-if", true), _ctx.totalText ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", _hoisted_3, (0, _vue.toDisplayString)(_ctx.totalText), 1
  /* TEXT */
...
var _default = (0, _vue.defineComponent)({
  ...
  setup(props) {
    ...
    (0, _vue.watch)([() => props.current, () => props.size], ([newCurrent, newSize]) => {
      current.value = (0, _shared.toNumber)(newCurrent) || 1;
      size.value = (0, _shared.toNumber)(newSize || 10);
    });
    (0, _vue.watch)([current, pageCount], ([newCurrent, newCount], [oldCurrent, oldCount]) => {
